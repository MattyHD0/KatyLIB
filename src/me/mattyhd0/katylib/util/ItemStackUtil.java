...
public class ItemStackUtil {
    ...
    public static ItemStack getSkullFromValue(String value, int amount){

        ItemStack skull = getSkullFromValue(value);
        skull.setAmount(amount);
        return skull;

    }

    public static ItemStack getSkullFromPlayer(String playerName){
    ...
    public static ItemStack getSkullFromPlayer(String playerName, int amount){

        ItemStack skull = getSkullFromPlayer(playerName);
        skull.setAmount(amount);
        return skull;
    ...
    public static ItemStack getItemStack(Material material, int amount, String name, String lore){
        ...
        for(String line: lore.split(";;")){
            coloredLore.add(StringUtil.color(line));
        }
    ...
    public static ItemStack getItemFromConfig(FileConfiguration config, String key){
        ...
        if(itemMeta != null) {
            ...
            if (name != null) itemMeta.setDisplayName(StringUtil.color(name));
            if (unbreakable) {
                try {
            ...
            if (lore.size() > 0) itemMeta.setLore(ArrayUtil.coloredList(lore));
            ...
            if(itemMeta instanceof BannerMeta){
                ...
                for(String patternStr: patternList){
                    ...
                    try {
                        ...
                        ((BannerMeta) itemMeta).addPattern(new Pattern(color, patternType));
            ...
            if(itemStack instanceof BookMeta){
                ...
                if(author != null) ((BookMeta)itemMeta).setAuthor(StringUtil.color(author));
                if(pages.size() > 0) ((BookMeta)itemMeta).setPages(ArrayUtil.coloredList(pages));
